    ...
    <div class="container">
        <div class="row row1">
            <ul class="largenav pull-right" align="right">
                ...
                <li class="upper-links"><a class="links" href="./Controller/session_destroy.php">Cerrar sesión</a>
                </li>
            </ul>
        </div>
        ...
        <div id="mySidenav" class="sidenav">
            <div class="container" style="background-color: #000000; padding-top: 10px;">
                ...
                <a class="menur" href="#">Cuenta</a>
                <a class="menur" href="#">Historial</a>
                <a class="menur" href="#">Ofertas</a>
                <a class="menur" href="#">Vender</a>
                <a class="menur" href="#">Ayuda</a>
